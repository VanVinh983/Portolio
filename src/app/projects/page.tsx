...
export default function Projects() {
    const projects: Project[] = [
        ...
        {
            title: "DigiTouch Application",
            period: "Jan 2023 - Dec 2024",
            role: "Mobile Developer",
            tech: "Flutter, MVVM, Provider, Firebase (Auth, FCM)",
            intro: "A digital business card app that lets users share contact info via QR codes, manage connections and chat in-app.",
            responsibilities: [
                "Designed the Flutter project architecture on the MVVM pattern for a scalable, maintainable codebase",
                "Built core features and managed state efficiently with Provider",
                "Integrated Firebase Authentication and Cloud Messaging (FCM) for users and push notifications",
                "Implemented QR-code scanning for card sharing and friend-connection workflows",
                "Developed and maintained in-app chat to enhance user interaction",
            ],
        },
        {
            ...
            period: "Jan 2023 - Dec 2024",
            role: "Mobile Developer",
            tech: "Flutter, Clean Architecture, BLoC, Firebase",
            intro: "A mobile e-commerce app focused on core shopping flows, scalable architecture and performance.",
            responsibilities: [
                "Applied Clean Architecture for a maintainable, scalable mobile codebase",
                "Used BLoC for state management and business-logic handling",
                "Built core features: product listing, product detail and related shopping flows",
                "Integrated Firebase Authentication and Cloud Messaging (FCM)",
                "Handled offline and network-failure UI states, and optimized rendering to cut load times",
            ],
        },
        {
