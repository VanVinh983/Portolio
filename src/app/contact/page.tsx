    ...
    return (
        <div className="pt-12 sm:pt-16 md:pt-24 pb-8 sm:pb-12 md:pb-16">
            <div className="max-w-4xl mx-auto px-4">
                <p className="cosmic-label mb-3">✦ comms channel</p>
                <h1 className="cosmic-heading text-3xl sm:text-4xl md:text-5xl mb-6 md:mb-8">
                    Let&apos;s <span className="text-gradient">make contact</span>
                </h1>
                <div className="cosmic-panel p-4 sm:p-6 md:p-8">
